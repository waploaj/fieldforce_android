...
import dev.encipher.tradewave.app.utils.helpers.animation.ReverseInterpolator;
import dev.encipher.tradewave.app.utils.helpers.animation.SupportAnimator;
import dev.encipher.tradewave.app.utils.helpers.animation.ViewAnimationUtils;
import dev.encipher.tradewave.app.utils.helpers.menu.MaterialMenuDrawable;
import dev.encipher.tradewave.app.utils.helpers.menu.MaterialMenuView;
...
public class SearchBox extends RelativeLayout {
	...
	/***
	 * Set whether to search without suggestions being available (default is true). Disable if your dev.encipher.tradewave.app only works with provided options
