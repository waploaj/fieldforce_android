...
class CallCardAdapter(val context: Context, private val callCards: ArrayList<CallCard>, private val onClickCallCard: (CallCard) -> Unit): androidx.recyclerview.widget.RecyclerView.Adapter<CallCardAdapter.Holder>() {
    ...
    inner class Holder(itemView: View?, val onClickCallCard: (CallCard) -> Unit) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView!!) {
